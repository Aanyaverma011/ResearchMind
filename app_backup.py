...
"""
            ...
            # Safety limit
            results["search"] = str(search_content)[:3500]
    ...
    with st.spinner("📄 Reader Agent is scraping the best source..."):
        ...
        try:
            ...
            reader_input = results["search"][:3000]
...
"""
            ...
            # Safety limit
            results["reader"] = str(reader_content)[:4500]
    ...
    with st.spinner("✍️ Writer is drafting the report..."):
        ...
        try:
            ...
            results["writer"] = str(results["writer"])
    ...
    with st.spinner("🧐 Critic is reviewing the report..."):
        ...
        try:
            ...
            # Don't send an unnecessarily huge report
            report_for_critic = results["writer"][:5000]

            results["critic"] = critic_chain.invoke({
                "report": report_for_critic
            })

            results["critic"] = str(results["critic"])
